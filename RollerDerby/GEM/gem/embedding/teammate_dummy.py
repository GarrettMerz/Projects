...
class Teammate(StaticGraphEmbedding):

    def __init__(self, *hyper_dict, **kwargs):
        ''' Initialize the Teammate class
        ...
        '''
        hyper_params = {
            'method_name': 'Teammate',
            'actfn': 'relu',
            'modelfile': None,
            'weightfile': None,
            'savefilesuffix': 'teammate'
...
if __name__ == '__main__':
    ...
    t1 = time()
    embedding = Teammate(d=2, beta=5, alpha=1e-5, nu1=1e-6, nu2=1e-6, K=3,
